...
@section('breadcrumb')
    <div class="flex justify-between items-center">
        <x-breadcrumb pageone="Package" />
        <x-button.button-plus route="{{ route('package.create') }}" title="Create Package" />
    </div>
@endsection
                                ...
                                @forelse ($packages as $package)
                                    <tr>
                                        <td
                                            ...
                                            {{ $packages->firstItem() + $loop->index }}</td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                            ...
                                            <x-table.crudactionbutton route="package" :id="$package->id" />
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
