...
@section('breadcrumb')
    <x-breadcrumb pageone="Package" class="py-2" pageoneRoute="{{ route('package.index') }}" pagetwo="Edit" />
@endsection
                    ...
                    <form action="{{ route('package.update',$package->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-12 gap-5 ">
                            <div class="col-span-12 lg:col-span-12 bg-white dark:bg-gray-800 p-4 rounded-lg">
                                <x-form.input label="Pakage Name" name="name" value="{{$package->name}}" />
                                <x-form.input label="Price" type="number" name="price" value="{{$package->price}}" />
                                                ...
                                                <tbody id="serviceTable">
                                                    ...
                                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                        <td scope="row"
                                                            ...
                                                            <input type="text" id="name" name="service[]" value="{{$servicename->service}}"
                                                        ...
                                                        <td class="px-6 py-4">
                                                            <select name="status[]">
                                                                <option value="0" {{ $servicename->status == 0 ? 'selected' : '' }}>No</option>
                                                                <option value="1" {{ $servicename->status == 1 ? 'selected' : '' }}>Yes</option>
                                                            </select>
