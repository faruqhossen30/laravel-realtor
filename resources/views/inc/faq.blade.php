...
<section>
    <div class=" Container mx-auto grid grid-cols-12 py-12">
        <div class="col-span-12 lg:col-span-6 p-8 space-y-1 ">
            <div id="accordion-collapse" data-accordion="collapse" data-accordion="collapse" class=" space-x-1 space-y-2 ">

                @foreach ($faqs as $key => $faq)
                    <div id="accordion-collapse-heading-{{ $faq->id }}" class=" flex justify-between border rounded-xl px-3 py-3 bg-[#FFF8F0] "
                        data-accordion-target="#accordion-collapse-body-{{ $faq->id }}" aria-expanded="false" aria-controls="accordion-collapse-body-{{ $faq->id }}">
                    ...
                    <div id="accordion-collapse-body-{{ $faq->id }}" class="@if ($key != 2) hidden  @endif"
        ...
        <div class="col-span-12 lg:col-span-6 p-8 space-y-3">
            <div class="px-6 space-y-10">
                <a href="" class="text-yellow-300 border font-bold border-yellow-400  rounded-full items-center py-2 px-8 ">
                    Read our FAQs</a>

                <h1 class="text-4xl font-bold text-primary">Explore Our Featured <br> Properties</h1>
                ...
                <div class=" flex space-x-3">
                    <h2 class="text-xl font-bold text-primary">Let's Chat</h2>
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-wechat text-brand" viewBox="0 0 16 16">
                            <path
