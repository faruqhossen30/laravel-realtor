...
<section class="bg-[#FFF6EB] py-12" id="reviewSection">
    <div class="container mx-auto  space-y-4">
        ...
        <h1 class="text-center pb-12 text-3xl font-semibold">Our Real Life Customer <br>Testimonials</h1>
    </div>
    <div class="container mx-auto grid grid-cols-12 gap-6">
        ...
        @foreach ($testmonials as $testmonial)
            <div class="col-span-12 lg:col-span-4 px-3">
                ...
                <div class=" bg-[#FFFFFF] border rounded space-y-8 p-5">
                    <div class=" flex justify-center  -mt-12">
                        <div class="  bg-brand p-4 inline-block rounded-full text-center ">
                    ...
                    <div class="flex items-center gap-x-4">
                        <img class="rounded-full size-12" src="{{ asset('storage/' . $testmonial->thumbnail) }}"
